/**
 * Cloudflare Worker — PromoScan AI proxy (Service Worker format)
 *
...
async function handleRequest(request) {
  ...
  // Variabili d'ambiente (disponibili come globali nel formato Service Worker)
  ...
  let regDoc = '';
  try {
    const regResp = await fetch(`https://raw.githubusercontent.com/${repo}/main/data/registration.txt`);
